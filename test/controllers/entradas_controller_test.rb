...
class EntradasControllerTest < ActionController::TestCase
  ...
  test "should create entrada" do
    assert_difference('Entrada.count') do
      post :create, entrada: { data_compra: @entrada.data_compra, produto_id: @entrada.produto_id, quantidade: @entrada.quantidade, valor_compra: @entrada.valor_compra }
    end
  ...
  test "should update entrada" do
    patch :update, id: @entrada, entrada: { data_compra: @entrada.data_compra, produto_id: @entrada.produto_id, quantidade: @entrada.quantidade, valor_compra: @entrada.valor_compra }
    assert_redirected_to entrada_path(assigns(:entrada))
  end
