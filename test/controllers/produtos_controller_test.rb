...
class ProdutosControllerTest < ActionController::TestCase
  ...
  test "should create produto" do
    assert_difference('Produto.count') do
      post :create, produto: { nome: @produto.nome, tipo_id: @produto.tipo_id, valor_venda: @produto.valor_venda }
    end
  ...
  test "should update produto" do
    patch :update, id: @produto, produto: { nome: @produto.nome, tipo_id: @produto.tipo_id, valor_venda: @produto.valor_venda }
    assert_redirected_to produto_path(assigns(:produto))
  end
